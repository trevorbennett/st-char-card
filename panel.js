...
export function updateCharacterDisplay(entry) {
    if (!entry) return;
...
export function refreshForCurrentView() {
...
export function createPanel() {
    ...
    const viewIdx = Roster.getViewIndex();
            ...
            <div class="hw-subpanel hw-stats-panel">
                ...
                <div class="hw-panel-bottom">
                    <div class="hw-nav">
                        ...
                        <span class="hw-nav-counter">${viewIdx + 1}/${rosterList.length}</span>
